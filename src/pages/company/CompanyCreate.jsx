...
export default function CompanyCreate() {
  ...
  const [form, setForm] = useState({
    ...
    companyAddr: "",
    companyTel: "",
    calcLogicName: "jp.co.ifnt.broster.v2.api.calc.component.impl.RosterDailyMtk",
    workingType: "1",
    ...
    <OwnerLayout title="会社登録">
      ...
      <div className="row row-padding-top-1">
        <div className="col-md-12">
          <h2><i className="fa fa-user-plus fa-fw"></i> 利用登録</h2>
      ...
      <form className="form-horizontal" onSubmit={submitForm}>
        ...
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">管理者名(初期登録)</label>
        ...
        {/* Address */}
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">会社住所</label>
        ...
        {/* Phone */}
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">会社TEL</label>
          <div className="col-md-2">
            <input
              className="form-control"
        ...
        {/* Working Type */}
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">就業形態</label>
          <div className="col-md-2">
            <label>
              <input
                type="radio"
        ...
        {/* Date Change Time */}
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">日付変更時刻</label>
          <div className="col-md-2">
            <select
              className="form-control"
            ...
            >
              {["24:00","25:00","26:00","27:00","28:00","29:00","30:00","31:00","32:00"].map(t => (
        ...
        {/* Week Flags */}
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">休日設定</label>
        ...
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">固定休憩控除閾値</label>
          <div className="col-md-2">
            <select
              className="form-control"
              value={form.fixBreakTimeDeduction}
              onChange={(e) => updateField("fixBreakTimeDeduction", e.target.value)}
            >
        ...
        {/* Year End Date */}
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">年度切替日</label>
          <div className="col-md-2">
            <input
              className="form-control"
        ...
        {/* Start Time Adjust */}
        <div className="form-group">
          <label className="col-md-offset-2 col-md-2 input-label">開始時間補正</label>
          <div className="col-md-2">
            <label>
              <input
                type="radio"
                ...
                onChange={(e) => updateField("adjustPlanStartTimeFlag", e.target.value)}
              />{" "}
              補正しない
            </label>{" "}
            <label>
        ...
        <div className="row row-padding-top-2">
          <div className="col-md-12 text-center">
            ...
            <a href="/status/show" className="btn btn-primary" style={{ marginLeft: 10 }}>
